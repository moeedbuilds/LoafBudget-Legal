...
**Effective date:** [DATE]
**Provider:** [Your legal name / company] ("we", "us", "our")
...
Loaf Budget is a personal budgeting tool that helps you model and understand your daily
cost of living. It is provided for personal, informational use.

## 2. Eligibility and accounts

You must be at least 13 years old (or the minimum age required where you live) to use the
app. You are responsible for keeping your account credentials secure and for all activity
under your account. Sign-in is available via Apple, Google, or email.
...
[Privacy Policy]([privacy policy URL]). You can export or delete your data at any time;
deleting your account permanently removes your data.

## 4. Acceptable use

You agree not to: misuse or interfere with the app or its security; attempt to access
accounts or data that are not yours; reverse-engineer or disrupt the service except as
permitted by law; or use the app for any unlawful purpose.
...
material changes, provide notice within the app. Continued use after changes take effect
means you accept the updated Terms.

## 10. Governing law

These Terms are governed by the laws of [your jurisdiction, e.g. State/Country], without
